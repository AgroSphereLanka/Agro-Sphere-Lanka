...
const char* mqtt_broker = "de04c99b55324353ab30381e5dca5e09.s1.eu.hivemq.cloud";
const int mqtt_port = 8883;
const char* mqtt_username = "Shashika";
const char* mqtt_password = "QC@90*msp";
...
// IR Sensor details
const int ir_sensor_pin = 4; // GPIO pin connected to the IR sensor
